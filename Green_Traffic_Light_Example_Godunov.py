...
trafficNumericalInEdgeOne    = NumericalFlux(name='Traffic Flow Numerical, One', fluxFunction=fluxcollection.concaveGodunov, analyticalFlux=fluxcollection.holdenRisebroFlow, analyticalDerivative=fluxcollection.derivativeHoldenRisebro, capacity=1.)
trafficNumericalInEdgeTwo    = NumericalFlux(name='Traffic Flow Numerical, Two', fluxFunction=fluxcollection.concaveGodunov, analyticalFlux=fluxcollection.holdenRisebroFlow, analyticalDerivative=fluxcollection.derivativeHoldenRisebro, capacity=1.)
trafficNumericalOutEdgeOne   = NumericalFlux(name='Traffic Flow Numerical, Three', fluxFunction=fluxcollection.concaveGodunov, analyticalFlux=fluxcollection.holdenRisebroFlow, analyticalDerivative=fluxcollection.derivativeHoldenRisebro, capacity=0.6)
trafficNumericalOutEdgeTwo   = NumericalFlux(name='Traffic Flow Numerical, Four', fluxFunction=fluxcollection.concaveGodunov, analyticalFlux=fluxcollection.holdenRisebroFlow, analyticalDerivative=fluxcollection.derivativeHoldenRisebro, capacity=0.6)
trafficNumericalOutEdgeThree = NumericalFlux(name='Traffic Flow Numerical, Five', fluxFunction=fluxcollection.concaveGodunov, analyticalFlux=fluxcollection.holdenRisebroFlow, analyticalDerivative=fluxcollection.derivativeHoldenRisebro, capacity=0.6)
trafficNumericalOutEdgeFour  = NumericalFlux(name='Traffic Flow Numerical, Six', fluxFunction=fluxcollection.concaveGodunov, analyticalFlux=fluxcollection.holdenRisebroFlow, analyticalDerivative=fluxcollection.derivativeHoldenRisebro, capacity=0.6)
